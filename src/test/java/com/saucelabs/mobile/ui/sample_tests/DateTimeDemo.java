...
import com.saucelabs.mobile.ui.utils.DateTime;
...
public class DateTimeDemo {
    ...
    public static void main(String[] args) {
        ...
        String current_year   = dateTime.formatIfDateTime("year");
        String past_year      = dateTime.formatIfDateTime("last year");
        String next_year      = dateTime.formatIfDateTime("next year");
...
//        System.out.println(test);
        ...
        log.debug("Current year                   : " + current_year);
        log.debug("Last year                      : " + past_year);
        log.debug("Next year                      : " + next_year);
